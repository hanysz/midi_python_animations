...
WINDOW = 30 # width of screen = 30 seconds
...
def draw_note(n, t):
  ...
  # else background.
  # Scroll left to right so that time t is always the centre of the screen
  offset = t/WINDOW*WIDTH - WIDTH/2
  x0 = n.t0/WINDOW*WIDTH - offset
  x1 = n.t1/WINDOW*WIDTH - offset
