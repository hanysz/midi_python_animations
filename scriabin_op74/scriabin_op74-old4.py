...
LENGTH = 351 # length of the video file to be generated, in seconds
#LENGTH = 15 # for testing
DELAY = 6 # number of seconds to allow for title screen
...
TIMES = [[    0,   4.0,   1.5,  56.0,  49.0,  55.4],
