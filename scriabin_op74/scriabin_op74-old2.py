...
LENGTH = 347 # length of the video file to be generated, in seconds

# Timing info: six numbers for each movement
# Fade in start and end times
# Playing start and end times (determine the position of notes on the screen)
# Fade out start and end
TIMES = [[    0,   2.0,   1.5,  56.0,  48.0,  55.4],
         [ 51.7,  56.7,  56.1, 136.7, 132.0, 138.3],
	 [134.0, 138.8, 138.4, 170.0, 167.0, 172.5],
	 [168.0, 174.2, 173.7, 292.4, 282.1, 293.0],
	 [288.0, 295.0, 293.6, 347.0, 342.0, 347.0]
	]
...
#AUDIO_OFFSET += 0.3
MIDI_STARTS = [0.2, 1.8, 1.4, 1.7, 3.7] # time of first event in each MIDI track
