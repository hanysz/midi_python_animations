...
MIDI_FILE = '/home/alex/midi/python_animations/midi/scriabin_op74/2016-12-Scriabin_op74_no2_v04.mid'
WAV_FILE_ORIGINAL = '/audio/2013-nov-concert/07-scriabin.wav'
WAV_FILE_TEMP = '/tmp/animation_audio.wav' # temporary store for padded version of audio
LENGTH = 81 # length of the video file to be generated, in seconds
...
TITLE_TEXT = "Scriabin prelude opus 74 number 2"
...
#TRACK_PLANES = [0,0, 0.5, 0, 0.2, 0.3, 0] # indexed by track number
TRACK_PLANES = [0,0, 0.1, 0, 0, 0, 0] # indexed by track number
...
LOWEST_NOTE = 15 # midi note number of the bottom of the screen
HIGHEST_NOTE = 90
