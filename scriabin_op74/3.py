...
MIDI_FILE = '/home/alex/midi/python_animations/midi/scriabin_op74/2016-12-Scriabin_op74_no3_v04.mid'
WAV_FILE_ORIGINAL = '/audio/2013-nov-concert/08-scriabin.wav'
WAV_FILE_TEMP = '/tmp/animation_audio.wav' # temporary store for padded version of audio
LENGTH = 33 # length of the video file to be generated, in seconds
AUDIO_OFFSET = 0 # number of seconds late to start the audio
MIDI_OFFSET = 0.2 # number of seconds to shift midi events by
TRACK_ORDER = [2, 3, 4, 5, 6, 7]
OUTPUT_FILE = '/home/alex/midi/python_animations/scriabin_prelude_op74no3.mp4'

TITLE_TEXT = "Scriabin prelude opus 74 number 3"
...
TRACK_PLANES = [0,0, 0.2, 0.5, 0.3, 0.7, 0.1, 0.2] # indexed by track number
BG_COLOUR = pygame.Color('darkgray')
#FG_COLOURS = [0, 0, YELLOW, WHITE, ORANGE, GREEN, BLUE, MAGENTA]
...
#PICTURE_PLANE = 5
GROW_TIME = 0.4 # how many seconds it takes for notes to grow to full size before they sound
...
def set_note_properties(n, t):
  ...
  col = [rgb for rgb in BG_COLOUR] # copy BG_COLOR and make it mutable so we can fade it out
...
def draw_note(n):
  ...
  pygame.draw.rect(screen, n.col, rescale(noterect, n.z))
...
def make_frame(t):
    ...
    for n in allnotes:
      set_note_properties(n, t-MIDI_OFFSET)
