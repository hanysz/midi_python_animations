...
TRACK_PLANES = [0,0, 1, 0.2, 0.2, 1.5, 0.1] # indexed by track number
BG_COLOUR = (50,50,50)
FG_COLOURS = [0, 0, YELLOW, WHITE, ORANGE, GREEN, BLUE]
...
#PICTURE_PLANE = 5
GROW_TIME = 0.3 # how many seconds it takes for notes to grow to full size before they sound
GROWTH_FACTOR = 30 # Enhanced growth as the notes get closer

LOWEST_NOTE = 18 # midi note number of the bottom of the screen
HIGHEST_NOTE = 95
