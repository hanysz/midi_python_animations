...
# Somewhat messy test file.  Uses input file midi/szymanowski_test.mid and audio/szymanowski_test.wav
...
INNER_BRIGHTNESS = 0.5 # brightness of the middle of the note when lit up
...
HEIGHT = 720
TITLE_FONT_SIZE = 30 # recommended: 45 if HEIGHT=1080, or 30 if 720
...
MIDI_FILE = 'midi/szymanowski_test.mid'
WAV_FILE_ORIGINAL = 'audio/szymanowski_test.wav'
WAV_FILE_TEMP = '/tmp/animation_audio.wav' # temporary store for padded version of audio
LENGTH = 35 # length of the video file to be generated, in seconds
AUDIO_OFFSET = 0 # number of seconds late to start the audio
MIDI_OFFSET = 0 # number of seconds to shift midi events by
TRACK_ORDER = [4,3,2,1]  # later tracks are drawn on top of earlier
...
LOWEST_NOTE = 30 # midi note number of the bottom of the screen
HIGHEST_NOTE = 107
